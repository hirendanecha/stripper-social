...
export function app(): express.Express {
  ...
  const distFolder = join(process.cwd(), 'dist/stripper-social/browser');
  ...
  const template = fs
    .readFileSync(
      path.join(
        join(process.cwd(), 'dist/stripper-social/browser'),
        'index.html'
      )
    )
    .toString();
    ...
    res.render(
      ...
      async (err, html) => {
        ...
        var seo: any = {
          ...
          site: 'https://www.stripper.social/',
          url: 'https://www.stripper.social' + params,
          keywords: 'Stripper.social',
        };
        if (
          ...
          const talent = {
            name: `Stripper.social Research ${group?.PageTitle}`,
